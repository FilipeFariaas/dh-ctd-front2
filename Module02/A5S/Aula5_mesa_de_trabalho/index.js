...
const itemsArray = [
	...
	},
	{
		...
		imagePath: "./imagens/leon.jpg",
	},
	{
		title: "O leopardo",
		description:
			"O leopardo (Panthera pardus) é um mamífero carnívoro da família dos felinos. Como três dos outros felinos do gênero Panthera: o leão, o tigre e a onça-pintada, são caracterizados por uma modificação do osso hióide que lhes permite rugir. É também conhecido como pantera mitemsArrayom e, quando tem a pelagem completamente escura, como pantera negra (melanista).",
		imagePath: "./imagens/leopardo.jpg",
	},
	{
		...
		imagePath: "./imagens/pantera-negra.jpg",
	},
	{
		title: "O jaguar",
		description:
